...
import { DELETE_ITEM, TOGGLE_CHECK } from "../store/mutation-type.js";
...
export default {
  ...
  methods: {
    ...mapMutations([DELETE_ITEM, TOGGLE_CHECK]),
    delItem(id) {
      this[DELETE_ITEM](id);
    },
  },
  computed: {
    isChecked: {
      ...
      set() {
        /*
          1.点击复选框修改vuex数据中该项数据的check值，定义mutation函数
        */
        this[TOGGLE_CHECK](this.eachItem.id);
      },
    },
  },
  props: {
