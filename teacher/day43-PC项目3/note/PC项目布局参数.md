...
- 总宽度`1200px`
- logo宽度 `175px*56px`   `margin:25px 45px`
- 右侧搜索框的上外边距 `35px`
- input搜索框
...
- 价格区域：上外边距`10px` 行高 28px
  - 四周padding是7px，背景颜色\#fee9ec
  - 左侧标题区域：右外边距`15px`
  - ¥字号`16px`   价钱字号`24px`   降价通知`12px`,*color*: #cc1122;
  - 第二行右侧区域 
    - 宽度`520px`
...
- 加入购物车区域
  ...
  - 左侧数字区域
    ...
    - 加法框：定位top:0
    - 减法框：定位`right：0px`  ，`top：19px`  上边框为0
  - 按钮区域：
    - 左右外边距 `25px`
    - 高度 `36px`
    - 字号大小`16px`
...
- 面包屑
  ...
  - \#7a6e6e url(../images/toolbars.png) -87px -174px no-repeat
  - \#7a6e6e url(../images/toolbars.png) -50px 0 no-repeat
  - \#7a6e6e url(../images/toolbars.png) -50px -100px no-repeat
  - \#7a6e6e url(../images/toolbars.png) -190px -150px no-repeat
  - \#7a6e6e url(../images/toolbars.png) -50px -150px no-repeat
  - \#7a6e6e url(../images/toolbars.png) -50px -250px no-repeat

  回到顶部：\#7a6e6e url(../images/toolbars.png) -50px -250px no-repeat
